...
* **Resolution:** Wrapped `run_recovery` in a fail-safe exception handler that logs the failure to the audit ledger while allowing the interactive checkout modal to proceed.
